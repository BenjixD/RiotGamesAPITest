...
public class GoogleSignIn extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "" + R.string.default_web_client_id);
    ...
    private void updateUI(FirebaseUser user) {
        if (user != null) {
            ...
            Toast.makeText(GoogleSignIn.this, "Authenticated.",
                    Toast.LENGTH_SHORT).show();
            signedIn();
        } else {
            findViewById(R.id.sign_in_button).setVisibility(View.VISIBLE);
            Toast.makeText(GoogleSignIn.this, "Not Authenticated.",
                    Toast.LENGTH_SHORT).show();
        }
    }

    private void signedIn(){
        Intent intent = new Intent(this, GetAPI.class);
